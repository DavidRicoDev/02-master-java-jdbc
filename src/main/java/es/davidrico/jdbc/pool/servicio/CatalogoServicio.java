...
import es.davidrico.jdbc.pool.repositorios.CategoriaRepositorioImpl;
import es.davidrico.jdbc.pool.repositorios.ProductoRepositorioImpl;
import es.davidrico.jdbc.pool.repositorios.Repositorio;
import es.davidrico.jdbc.pool.modelos.Categoria;
import es.davidrico.jdbc.pool.modelos.Producto;
import es.davidrico.jdbc.pool.util.ConexionBaseDatos;
